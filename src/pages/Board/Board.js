...
import createBoardStyles from './../CreateBoard/CreateBoard.module.css';
...
class Board extends Component {
    ...
    componentDidMount() {
        let url = 'https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/boards/'+this.props.match.params.boardId+'.json';
        Axios.get(url)
            .then(response => {
                this.setState({
        ...
        Axios.get('https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/archivedBoards.json')
            .then(response => {
                let archivedCards = [];
    ...
    addColumnToDBHandler = () => {
        if(this.addColumnRef.current.value.length <= 0) {
            ...
            Axios.put('https://pro-organizer-2a21a.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn.json', updatedBoardData)
                .then(response => {
